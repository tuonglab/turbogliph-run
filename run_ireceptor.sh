...
#SBATCH -o run_new.output
#SBATCH -e run_new.error
...
# /scratch/user/uqachoo1/envs/R/bin/Rscript

srun /home/uqachoo1/.conda/envs/R/bin/Rscript run_turbogliph_ireceptor.r /QRISdata/Q5935/for_amos /scratch/project/tcr_ml/GLIPH2_output/new_samples